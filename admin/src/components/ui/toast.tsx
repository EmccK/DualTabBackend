...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.success]:text-green-600/70 group-[.success]:hover:text-green-600 group-[.destructive]:text-red-600/70 group-[.destructive]:hover:text-red-600",
      className
    )}
    toast-close=""
    {...props}
